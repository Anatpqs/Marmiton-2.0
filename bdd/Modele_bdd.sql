...
CREATE TABLE IF NOT EXISTS `mydb`.`Tag` (
  ...
  `Recette_assoc` INT NOT NULL,
  PRIMARY KEY (`IdTag`, `Recette_assoc`),
...
-- -----------------------------------------------------
-- Table `mydb`.`Rectte_pref`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mydb`.`Rectte_pref` ;

CREATE TABLE IF NOT EXISTS `mydb`.`Rectte_pref` (
