...
START TRANSACTION;
USE `mydb`;
INSERT INTO `mydb`.`Recette` (`IdRecette`, `Nom`, `IdCréateur`, `Notemoy`, `Nb_personne`, `Temps_prep`, `Temps_cuis`, `Description`, `Instruction`, `Image`) VALUES (DEFAULT, 'gateau', 1, 4, 5, 15, 20, 'vraient bon', '1 puis2 puis 3', NULL);
...
START TRANSACTION;
USE `mydb`;
INSERT INTO `mydb`.`Commentaire` (`IdCommentaire`, `Commentaire`, `Note`, `IdAuteur`, `Recette_com`, `Date`) VALUES (DEFAULT, 'Vriamnet unique', 1, 1, 1, '');
