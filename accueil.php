...
<html>
  ...
  <body>
    <div id="barre">
      ...
      <img class="icon" src="Images/chiefblanc.png"> <!--// TODO Lien vers l'ajout de recette si connecter sinon, demande de connexion puis redirection vers page ajout recette -->
      <!-- Menu déroulant -->
      <div class="profil">
        <ul class="navbar">
