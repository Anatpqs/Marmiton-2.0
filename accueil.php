...
$req_sql_RecetteDuMoment = $db->prepare('SELECT r.IdRecette, r.Nom, r.Notemoy, r.Description, COUNT(c.IdCommentaire) AS NbCommentaires
                                        FROM Recette r
                                        LEFT JOIN Commentaire c ON r.IdRecette = c.Recette_com
                                        WHERE État!=0
                                        GROUP BY r.IdRecette, r.Nom, r.Notemoy, r.Description
...
<header id="barre">
    ...
    <form class="textlink" method="post" id="Cuisiner pas cher" action="Recherche.php">
        ...
        <a href="#" class="textlink" onclick="document.getElementById('Cuisiner pas cher').submit();">Cuisiner pas
            cher</a>
    </form>
    ...
    <div class="corps">
        ...
        <div class="recette_du_moment">
            <div class="recette_du_moment affichage">
                ...
                <h3 class="textblanc">
                    <?php echo $RecetteDuMoment['Nom']; ?>
                </h3>
                <!-- Lien vers la recette -->
                <form id="myForm3" action="recette.php" method="post">
                    <input type="hidden" name="idRecette" value="<?php echo $RecetteDuMoment["IdRecette"] ?>">
                </form>
                <a class="imageMoment" href="#" onclick="document.getElementById('myForm3').submit();"><img
                        class="image" src="Images/Recette/<?php echo $RecetteDuMoment['IdRecette']; ?>.jpg"> </a>
                <!-- -------------------- -->
                <?php
                //Si la recette vient d'être créé pas de note
                ...
                ?>
                <p class="textblanc">
                    <?php echo $RecetteDuMoment['Description']; ?>
                </p>
            </div>
        </div>
