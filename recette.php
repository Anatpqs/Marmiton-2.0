...
<body>
    ...
    <div id="main">
        ...
        <div id="info">
            ...
            <p><strong>Prix : </strong><span class="data"><span id="prix"> 5</span> euros</span></p>
        </div>
        ...
        <ul>
            ...
            {
            echo "<li>".$row["Nom"]." : <span>".$row["Quantité"]."</span>".$row["Unité"]."</li>";
            };
            ?>
            <!-- <li>chocolat noir : <span id="ig1">200</span>g</li>
            <li>beurre : <span id="ig2">125</span>g</li>
            <li>sucre : <span id="ig3">125</span>g</li>
            <li>oeufs : <span id="ig4">3</span></li>
            <li>farine : <span id="ig5">60</span>g</li> -->
        </ul>
        <br>
